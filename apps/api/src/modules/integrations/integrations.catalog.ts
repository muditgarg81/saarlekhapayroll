...
export const PROVIDER_CATALOG: ProviderDef[] = [
  ...
  // ── Biometric devices ───────────────────────────────────────
  {
    ...
    fields: [
      { key: 'serialNumber', label: 'Device Serial (SN)', type: 'text', required: true, help: 'Must match the device SN in the push/ADMS feed' },
      { key: 'deviceIp', label: 'Device IP', type: 'text', placeholder: '192.168.1.201' },
  ...
  },
  {
    ...
    operations: [{ key: 'ATTENDANCE_PULL', label: 'Import Punch Logs', direction: 'INBOUND' }],
    fields: [
      { key: 'serialNumber', label: 'Device Serial (SN)', type: 'text', required: true, help: 'Must match the device SN used in the push/ADMS feed' },
      { key: 'serverUrl', label: 'eTimeTrack Server URL', type: 'url', placeholder: 'http://localhost:8080' },
      { key: 'deviceIp', label: 'Device IP', type: 'text', placeholder: '192.168.1.100' },
      { key: 'port', label: 'Port', type: 'text', placeholder: '4370' },
